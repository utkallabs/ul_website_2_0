...
if (data.filter(d => ((d.techStack.indexOf("html") != -1))).length > 1) {

    document.getElementById("solutions-list").innerHTML = data.filter(d => ((d.techStack.indexOf("html") != -1)))
        .map(
            (eachCard) =>
                `<div class="card-wrapper col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30" data-technology="${eachCard.title, eachCard.techStack}">
    ...
    document.getElementById("solutions-list").innerHTML = ` <div class="shadow py-5">
